  ...
  return (
    <div className="lg:p-16  p-4">
      ...
      <p>
        ...
        adjustment in any situation. So you can enjoy a rocking motion chair by
        rolling it. Users can tilt 140 degrees in the back position with
        adjustment. Ergon Heart provides the best service for people who need to
        sit for a long time for their work and need to relax for some time. It
        is made with a 5-star metal base with a smooth PU caster wheel with
      ...
      <h1 className="font-semibold my-2 text-xl">Comfort Enhancing Features</h1>
      <p>
        ...
        support which gives you proper and comfortable support for your body. It
        enables you to enjoy your gaming sessions more comfortably.
      </p>
    </div>
  );
};
